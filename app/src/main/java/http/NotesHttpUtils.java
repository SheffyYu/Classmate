...
public class NotesHttpUtils {
    // 做网络请求使用的对象
    private static final OkHttpClient client = new OkHttpClient();

    //获取同学录列表
    public void getAllNotes(String userId,final HttpCallback callback){
        Type t = new TypeToken<List<NotesBean>>(){}.getType();
        getData(ServerUrl.GET_ALL_NOTES + userId,callback,t);
    }
